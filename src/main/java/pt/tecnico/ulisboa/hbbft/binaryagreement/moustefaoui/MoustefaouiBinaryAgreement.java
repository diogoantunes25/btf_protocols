...
public class MoustefaouiBinaryAgreement implements IMoustefaouiBinaryAgreement {
    ...
    // Called when there's a change N-f AUX messages are received and there might be progress to make (I think ?)
    private Step<Boolean> tryOutputSbv() {
        ...
        if (this.coin.hasDecided()) {
            // (dsa) If coin has already decided, then skip conf part
